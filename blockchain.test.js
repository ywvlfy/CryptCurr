...
describe("Blockchain", () => {
	...
	beforeEach(() => {
		//resets  blockchain to a new Blockchain instance for each test
	...
	it("adds a new block to the chain", () => {
		...
		expect(blockchain.chain[blockchain.chain.length - 1].data).toEqual(
			newData
		); //checks the last item in the chain array is the newest block
	});

	describe("isValidChain", () => {
		describe("when the chain does not start wit the genesis block", () => {
			it("returns false", () => {
